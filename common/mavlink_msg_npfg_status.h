...
typedef struct __mavlink_npfg_status_t {
 ...
 float lat_accel; /*< [m/s/s] Resultant lateral acceleration reference*/
 float lat_accel_ff; /*< [m/s/s] Feed-forward lateral acceleration for maintaining path curvature*/
 ...
 * @param lat_accel [m/s/s] Resultant lateral acceleration reference
 * @param lat_accel_ff [m/s/s] Feed-forward lateral acceleration for maintaining path curvature
 ...
 *
 * @return [m/s/s] Resultant lateral acceleration reference
 */
 ...
 *
 * @return [m/s/s] Feed-forward lateral acceleration for maintaining path curvature
 */
